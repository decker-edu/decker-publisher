...
configuration.username = config().database.pg_user;
configuration.password = config().database.pg_pass;
configuration.database = config().database.pg_base;
configuration.hostname = config().database.pg_host;
configuration.port = config().database.pg_port;
